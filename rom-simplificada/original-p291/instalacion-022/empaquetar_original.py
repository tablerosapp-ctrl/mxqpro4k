...
OUTPUT = HERE/'salida'
GO_SOURCES = ('block_layout.go','block_layout_test.go','block_device_linux.go','go.mod','package.go','data_policy.go','package_test.go','main_linux.go','main_windows.go','backup_verified.go','backup_verified_test.go','userdata_linux.go','transaction_linux.go','env_guard.go','env_guard_test.go','block_abi.go','block_abi_test.go')
...
def package(operation,report):
    ...
    result={'layout_review':layout_review,'version':VERSION,'package_id':ident,'operation':operation_id,'file':final.relative_to(ROOT).as_posix(),
            ...
            'pending_before_install':['physical_022_package_layout_backup_format_flash'],
