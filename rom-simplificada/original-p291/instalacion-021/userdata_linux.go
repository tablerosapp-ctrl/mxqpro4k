...
func dataTarget(disk string) (Target, error) {
	size, r, actual, e := block("/dev/block/data")
	if e != nil {
		return Target{}, e
	}
	if size != userdataBytes || mm(r) != "179:20" || actual != disk {
	...
	return Target{Image: Image{Name: "data", Size: size, MajorMinor: "179:20"}, Path: "/dev/block/data", Size: size, Device: r, MajorMinor: "179:20", Disk: disk}, nil
}
...
func requireUnmountedData(t Target) error {
	...
	if current.Device != t.Device || current.Size != t.Size {
