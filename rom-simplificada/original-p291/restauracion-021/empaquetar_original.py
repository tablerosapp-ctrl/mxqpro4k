"""Build the five-partition ORIGINAL-RESTORE-0.2.1 package, PC only.
...
OUTPUT = HERE/'salida'
GO_SOURCES = ('go.mod','package.go','package_test.go','main_linux.go','main_windows.go','block_abi.go','block_abi_test.go','backup_verified.go','backup_verified_test.go','transaction_linux.go','env_guard.go','env_guard_test.go','env_read_linux.go')
