...
final class Evidencia {
  ...
  String collect(Access access,String id,String dt,String sdk,String token,Progress progress)throws IOException {
    ...
    progress.stage("1/7 · Creando una carpeta nueva en el pendrive TVBASE… El TV no se reiniciará.");
    ...
    String[] stages={"2/7 · Guardando datos del arranque y las particiones…","3/7 · Copiando los registros persistentes completos…","4/7 · Leyendo los datos del actualizador original…","5/7 · Copiando el actualizador y sus certificados públicos…","6/7 · Leyendo la configuración de arranque accesible…","7/7 · Comprobando tamaños, hashes y finalización…"};
