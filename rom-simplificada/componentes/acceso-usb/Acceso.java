...
public class Acceso extends Activity {
  ...
  @Override public void onCreate(Bundle state) {
    ...
    TextView title=new TextView(this);title.setText("Evidencia de Android TV Base · 0.5");title.setTextSize(25);list.addView(title);
    TextView detail=new TextView(this);detail.setText("Conectá el pendrive TVBASE y guardá la evidencia del último intento. Esta versión solo lee datos de arranque y copia los registros y el actualizador original al USB. No reinicia, no abre el actualizador y no instala la ROM. No necesita WiFi ni Internet.");detail.setTextSize(18);list.addView(detail);
    collect=button(list,"Guardar evidencia del último intento (no reinicia)");collect.setEnabled(!attempted);collect.setOnClickListener(new View.OnClickListener(){public void onClick(View v){access(true);}});
