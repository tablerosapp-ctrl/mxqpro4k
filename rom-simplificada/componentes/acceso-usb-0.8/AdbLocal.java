...
final class AdbLocal implements Closeable,Evidencia.Access {
  ...
  public String evidenceStep(int step,String directory,String token)throws IOException {
    String command=EvidenciaScripts.command(step,directory,token);
    readTimeoutMillis=90000;
    try{return service("shell:"+command,90000000000L);}finally{readTimeoutMillis=5000;socket.setSoTimeout(5000);}
  }
