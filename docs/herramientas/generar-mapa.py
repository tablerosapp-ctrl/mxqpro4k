...
for p in sorted(ROOT.rglob('*')):
    ...
    if rel in derived or rel.startswith((private + '/', 'privado/', '.publicacion/', 'Rockchip Create Upgrade Disk Tool v1.53/')) or any(x in '/' + rel for x in ('/.git/', '/privado/', '/crudos/', '/originales/')):
        continue
