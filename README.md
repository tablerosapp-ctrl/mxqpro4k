...
**Nueva captura P271 conservada y verificada; corrección 0.2 para el bloqueo del MX9.** [Hallazgos](diagnostico/reconocimiento-20260908-p271-mx9/HALLAZGOS.md) · [Reconocedor 0.2](diagnostico/reconocedor-0.2/README.md) · [Entrega y pruebas](docs/evidencia/RECONOCEDOR-USB-02.md). P271 aportó archivos accesibles y mapa sysfs; no se debe repetir su captura por rutina. El nombre comercial MX9 5G todavía no identifica su hardware.

La versión 0.2 guarda una ficha inicial en USB antes de ampliar el inventario, sin copiar masivamente drivers ni DT. Si falla una consulta, conserva su límite; no acumula trabajadores bloqueados. La copia profunda sigue en el [extractor de recovery0.1](diagnostico/extractor-recovery-0.1/README.md). El plan P271 se deriva del ZIP recibido, pero entrada/firma/ejecución en recovery siguen pendientes. [Entrega previa del extractor](docs/evidencia/EXTRACTOR-RECOVERY-01.md). La revisión de telefonía y software heredado queda priorizada, sin retirar servicios en esta entrega.
