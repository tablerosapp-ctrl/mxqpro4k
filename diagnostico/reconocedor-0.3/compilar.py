...
def main():
    if (HERE/"COMPILACION.json").exists(): raise RuntimeError("Release already sealed; do not overwrite")
    ...
    final=out/'Reconocimiento-TVBase-0.3.apk'
    ...
    assert b"name='com.tvbase.reconocimiento'" in badging and b"versionName='0.3'" in badging and b"minSdkVersion:'21'" in badging
