...
func run() error {
	...
	say("TV Base - Extraccion de originales 0.2 en SD. No instala ni formatea.")
	sd, e := findSD()
	if e != nil {
		return e
	}
...
func main() {
	if len(os.Args) == 2 && os.Args[1] == "--help" {
		fmt.Println("TV Base extractor 0.2 SD; solo protocolo update-binary desde recovery. Sin plan APK coincidente guarda inventario; no instala ROM.")
		return
	}
