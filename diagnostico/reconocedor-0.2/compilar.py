...
def main():
    ...
    final=out/'Reconocimiento-TVBase-0.2.apk'
    ...
    assert b"name='com.tvbase.reconocimiento'" in badging and b"versionName='0.2'" in badging and b"minSdkVersion:'21'" in badging
